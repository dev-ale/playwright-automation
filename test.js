...
(async () => {
    ...
    // Launch Chromium in headful mode2
    ...
    await page.goto('http://www.protekta.ch/');
    await page.goto('http://www.protekta.ch/de');
    await page.getByRole('button', { name: 'Alle Cookies akzeptieren' }).click();
    await page.getByRole('link', { name: 'Rechtsschutz für Privatpersonen Streit in der Nachbarschaft? Ärger mit dem' }).click();
    ...
    await page.getByPlaceholder('TT.MM.JJJJ').fill('10.03.1990');
